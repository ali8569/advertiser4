...
static jlong
native_create(JNIEnv *env, jobject, jstring jport, jint baudrate, jintArray jtimeout, jint bytesize,
              jint parity, jint stopbits, jint flowcontrol) {
...
static jint
native_read(JNIEnv *env, jobject, jlong ptr, jbyteArray jbuffer, jint offset, jint size) {
...
int registerSerial(JNIEnv *env) {
    ...
    gIllegalArgumentException = findClass("java/lang/IllegalArgumentException",
                                          FIND_CLASS_RETURN_GLOBAL_REF);
