...
public class Utils {
    ...
    public static String getDateString(long timestamp, String calendarType) {
        switch (calendarType) {
            case "persian":
                return getPersianDateString(timestamp);
            case "gregorian":
                return getGregorianDateString(timestamp);
            default:
                return "NA";
        }
    }
    ...
    public static void fade(View toVisibale, final View toFade, int duration, boolean gone) {
        toVisibale.setAlpha(0f);
        toVisibale.setVisibility(View.VISIBLE);
        toVisibale.animate().alpha(1f)
                .setDuration(duration)
