...
public class Signal implements Serializable {
    ...
    public static final int ENABLE_POLICE = 0x00002000;
    public static final int DISABLE_POLICE = 0x00004000;

    public static final int CAMERA_OPENED = 0x00010000 | DISABLE_POLICE;
    public static final int CAMERA_CLOSED = 0x00020000 | ENABLE_POLICE;

    public static final int GOLD_DOWNLOADER_FINISHED = 0x00040000;
    public static final int GOLD_TITLE_LOADED = 0x00080000;
