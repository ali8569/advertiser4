...
public class MainActivity extends BaseActivity implements SignalReceiver,VideoFragment.VideoStateChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        socket=((AdvertiserApplication)getApplication()).getSocketManager();
    ...
    private void showRecord(final Record record) {
        ...
        if (record.getVideoFiles().isEmpty() && !record.getPhotosArrayObject().isEmpty()) startTimer(record,0);
        else {
            if (soundPlayer!=null)
                soundPlayer.setPlayWhenReady(false);
        }
    ...
    private void initLayout(String layoutType) {
        ...
        switch (layoutType){
            case "main": break;
            case "vertical_2part": init2PartLayer(false); break;
            case "horizontal_2part": init2PartLayer(true); break;
            case "horizontal_3part": init3PartLayer(); break;
            case "horizontal_4part_1": init4Part1Layer(); break;
            case "horizontal_4part_2": init4Part2Layer(); break;
            case "vertical_4part": init4PartVerticalLayer(); break;
            case "vertical_doctor": initVerticalDoctor(); break;
            case "horizontal_doctor": initDoctorLayout(); break;
            case "horizontal_special": initSpecialLayout(); break;
    ...
    private void initExtras(Record record){
        ...
        switch (record.getLayoutType()){
            case "main":break;
            case "vertical_2part":
            case "horizontal_2part": init2PartExtras(record.getExtras()); break;
            case "horizontal_3part": init3PartExtras(record.getExtras()); break;
            case "horizontal_4part_1": init4Part1Extras(record.getExtras()); break;
            case "horizontal_4part_2": init4Part2Extras(record.getExtras()); break;
            case "vertical_4part": init4PartVerticalExtras(record.getExtras()); break;
            case "vertical_doctor": initDoctorVerticalExtras(record.getExtras()); break;
            case "horizontal_doctor": initDoctorExtras(record.getExtras()); break;
            case "horizontal_special": initSpecialExtras(record.getExtras(),record.getRecordId()); break;
        }
    }
